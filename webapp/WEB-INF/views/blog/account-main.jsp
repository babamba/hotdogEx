												...
												<div class="userpage">
													...
													<form name="uploadImages" method="post"	enctype="multipart/form-data">
														...
														<div class="col-sm-4">
															<div class="input-group">
																<span class="input-group-addon"> <i class="fa fa-group"></i>
																</span> <input id="pass_word" type="password" class="form-control" placeholder="${map.userVo.pass_word }" >
															</div>
														</div>
															<div class="col-sm-4">
															<div class="input-group">
																<span class="input-group-addon"> <i class="fa fa-group"></i>
																</span> <input id="pass_wordCheck" type="password" class="form-control" placeholder="${map.userVo.pass_word }" >
															</div>
														</div>
											...
											<div class="tab-pane" id="pet_profile">
												<form name="uploadImages" method="post"	enctype="multipart/form-data">
														...
														<div class="col-sm-4">
															<div class="input-group">
																<span class="input-group-addon"> <i class="fa fa-group"></i>
																</span> <input id="age" type="text" class="form-control" placeholder="${map.petVo.age }"
																				onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' style='ime-mode:disabled;'>
															</div>
														</div>
											...
											<script>
												...
												var loadFile3 = function(event) {
												 ...
												 $("#petProfileSave").click(function(){
													 ...
													 $.ajax({
														 url:"${pageContext.request.contextPath}/user/account" + petUrl,
													 	 type:"post",
														 data: formData , 
														 processData : false,
											             contentType : false
