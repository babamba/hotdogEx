						...
						<div class="col-md-5 col-sm-5 col-xs-5" >
								...
								<div class="col-md-12 col-sm-6 col-xs-6">
										...
										<div class="row">
												...
												<a href="${pageContext.request.contextPath}/blog/${authUser.nickname}/streaming" style="color:white;"><div class="row button transparent effect fill-vertical col-md-4 col-sm-4 col-xs-1 text-center" style="margin-left:8px; margin-right:0px;"><span>스트리밍</span></div></a>						
